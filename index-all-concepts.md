...
- **Layer Normalization** - [Layer Normalization](docs/ai-core/transformer-architecture.md#layer-normalization)
- **Logits** - [工具选择的概率决策](docs/ai-core/agent-architecture.md#q1-claude-怎样决定调用哪个工具)
- **Loop Node** - [循环节点](docs/ai-application/workflow-design-guide.md#5-loop-node循环节点)
- **Lost in the Middle** - [Lost in the Middle 现象](docs/ai-core/context-window-guide.md#lost-in-the-middle)
...
- **Multi-Agent Scaling（多智能体并行扩展）** - [Multi-Agent Scaling](docs/ai-core/multi-agent-scaling.md)
...
- **Quantization** - [量化](docs/ai-research/models-deep-dive.md#模型压缩技术)
...
- **Recursive Self-Improvement（递归自我改进）** - [递归自我改进（RSI）](docs/ai-research/recursive-self-improvement.md)
...
- **Research Taste（研究品味）** - [递归自我改进（RSI）](docs/ai-research/recursive-self-improvement.md#人类最后的壁垒研究品味research-taste)
- **RSI（Recursive Self-Improvement，产业级反馈循环）** - [OpenAI Intelligence Platform](docs/career-impact/openai-intelligence-platform.md#rsi-的产业级反馈循环) · [Research Acceleration](docs/ai-research/research-acceleration.md) · [递归自我改进](docs/ai-research/recursive-self-improvement.md)
...
- **Temperature** - [采样参数](docs/ai-core/inference-system-guide.md#采样参数)
- **Tool Selection** - [工具调用机制](docs/ai-core/agent-architecture.md#工具调用机制)
- **Tool Use Block** - [工具调用的生成](docs/ai-core/agent-architecture.md#tool-definition-的最佳实践)
...
- **Vertical Agent** - [垂直 vs 通用 Agent](docs/ai-application/skills-business-landscape.md#垂直-vs-通用-agent)
