...
> 完全没有 AI 技术背景？从这里开始。这不是课程，是一张**最小地图**——用 30 分钟看完这 8 站，你不会成为专家，但会知道这个 Wiki 里其他文章在讨论什么、彼此怎么连接。看完之后，去 [AI Core](docs/ai-core/index.md)、[心智模型](mental-models.md) 或任何你好奇的地方自由探索就行。
>
...
一句"是什么"的速查（它们的**关系看上面这张图**，下表只逐个解释，不是从上到下越来越高级）：
